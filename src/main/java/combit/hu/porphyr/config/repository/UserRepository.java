...
public interface UserRepository extends CrudRepository<UserEntity, Long> {
    @Nullable
    UserEntity findByLoginName(final @NonNull String loginName);

    @Nullable
    UserEntity findAllById(final @NonNull Long userId);
    ...
    @NonNull
    List<UserEntity> findAllByLoginNameAndIdNot(final @NonNull String loginName, final @NonNull Long id);
